...
import { Check, Mail, MessageCircle, Search, UsersRound } from 'lucide-react'
  ...
  return <main className={styles.app}>
    ...
    <div className={styles.issuerLayout}><IssuerLabSidebar organizationId={org?.id} organizationName={org?.name} cityName={city?.name} />
      <section className={styles.issuerMain} aria-label="Volunteer roster">
        <section className={styles.issuerPageHero}><div><p className={styles.eyebrow}>Volunteer roster</p><h1>See people, not sign-ups.</h1><p>A practical view of who is expected, who is new, and how your organization’s volunteer community is taking shape.</p></div></section>
