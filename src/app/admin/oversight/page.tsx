...
export default async function OversightPage({
  ...
  return (
    <>
      <PageHeader
        title="Oversight"
        subtitle="Network-wide overrides for opportunities, redemptions, and the MyCity Feed. Every action is ledgered."
      />
      <Flash searchParams={searchParams} />

      <Card className="mb-8 flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-ink-800">Reminders</p>
          <p className="text-xs text-ink-400">
            Deliver due shift confirmations and pre-shift reminders now. In production a cron hits{' '}
